...
function Sidepanel () {
    ...
    <div id="sidepanel-drop" class="sidepanel-drop" onClick={ev.sidePanelToggler}></div>
    <div class="sidepanel-inner d-flex flex-column">
        <a href='#' id="sidepanel-close" onClick={ev.sidePanelClose} class="sidepanel-close d-xl-none">&times;</a>
